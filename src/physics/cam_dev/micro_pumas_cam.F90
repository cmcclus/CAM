...
subroutine micro_pumas_cam_init(pbuf2d)
   ...
   call addfld ('NPCCN',      (/ 'trop_cld_lev' /), 'A', '#/kg/s',  'Number Tendency due to Cloud Droplet Activation')
   ...
   if ( history_budget ) then
      ...
      call add_default ('NPCCN    ', budget_histfile, ' ')
...
!        endif
   ...
   call outfld ('NPCCN',    proc_rates%npccntot   , ncol, lchnk, avg_subcol_field=use_subcol_microp)
